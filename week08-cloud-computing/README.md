...
You would run Docker Compose commands in the format `docker compose
COMMAND`.  Take a look at the output of `docker compose help` to get
...
Your `compose.yml` is in `~/data` directory of your cloud VM:
